...
$_SESSION['LAST_ACTIVITY'] = time();
	include('assets/inc/config.php');
        ...
        $pat_number = htmlspecialchars($_POST['pat_number'], ENT_QUOTES, 'UTF-8');
        $pat_phone = htmlspecialchars($_POST['pat_phone'], ENT_QUOTES, 'UTF-8');
        $pat_type = htmlspecialchars($_POST['pat_type'], ENT_QUOTES, 'UTF-8');
        $pat_addr = htmlspecialchars($_POST['pat_addr'], ENT_QUOTES, 'UTF-8');
        $pat_age = htmlspecialchars($_POST['pat_age'], ENT_QUOTES, 'UTF-8');
