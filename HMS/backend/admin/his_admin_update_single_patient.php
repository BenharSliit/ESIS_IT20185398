...
/*            $pat_id = $_GET['pat_id'];
		...
		$pat_id = $_GET['pat_id'];	    
	    $pat_fname = htmlspecialchars($_POST['pat_fname'], ENT_QUOTES, 'UTF-8');
    $pat_lname = htmlspecialchars($_POST['pat_lname'], ENT_QUOTES, 'UTF-8');
    $pat_number = $_POST['pat_number']; // Validate and sanitize as needed
    $pat_phone = $_POST['pat_phone']; // Validate and sanitize as needed
    $pat_type = htmlspecialchars($_POST['pat_type'], ENT_QUOTES, 'UTF-8');
    $pat_addr = htmlspecialchars($_POST['pat_addr'], ENT_QUOTES, 'UTF-8');
    $pat_age = $_POST['pat_age']; // Validate and sanitize as needed
    $pat_dob = htmlspecialchars($_POST['pat_dob'], ENT_QUOTES, 'UTF-8');
    $pat_ailment = htmlspecialchars($_POST['pat_ailment'], ENT_QUOTES, 'UTF-8');
...
/*
	...
	if (is_numeric($pat_id)) {
		...
		// Check if the session is older than a certain period (e.g., 30 minutes)
if (isset($_SESSION['LAST_ACTIVITY']) && (time() - $_SESSION['LAST_ACTIVITY'] > 1800)) {
    // The session has timed out, so log the user out or take appropriate action.
