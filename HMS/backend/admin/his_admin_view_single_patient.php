...
while ($row = $res->fetch_object()) {
    $mysqlDateTime = $row->pat_date_joined;
    $pat_fname = htmlspecialchars($row->pat_fname, ENT_QUOTES, 'UTF-8');
    $pat_lname = htmlspecialchars($row->pat_lname, ENT_QUOTES, 'UTF-8');
    // Similarly, sanitize and escape other variables if needed.
}
?-->
